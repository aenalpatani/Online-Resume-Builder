...
?>
	<img src="<?php echo "images/".$row1['Profile_photo']; ?>" style="margin-left:50px" width="60%" height="15%" alt="Profile pic">
...
<?php
	...
	{
?>
<H5 CLASS="PERSONAL">Resume Builder</H5>
...
<input type="button" class="down" onclick="printContent('RESUME')" value="Download">
<script>

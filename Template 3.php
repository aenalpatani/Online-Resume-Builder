...
<?php
 $xyz1="SELECT * FROM `personal_information`where User_id='$user_id'";
		...
		$row=mysqli_fetch_array($query1);
		 ...
		 {
    ?>  
	<img src="<?php echo "images/".$row['Profile_photo']; ?>" style="margin-left:50px;" width="60%" height="15%" alt="Profile pic">
...
<p class="a"><?php echo $row['Skill']?></p>
<?php
}
?>
</div>	
...
<?php
 $xyz9="SELECT * FROM `objectives` where User_id='$user_id'";
        $query9 = mysqli_query($con, $xyz9);

         while($row=mysqli_fetch_array($query9))
		 {
    ?>  

<p class="a"><?php echo $row['Objective']?></p>
<?php
}
?>
</div> 
...
<?php
 $xyz10="SELECT * FROM `project` where User_id='$user_id'";
        $query10 = mysqli_query($con, $xyz10);

         while($row=mysqli_fetch_array($query10))
		 {
    ?>  

<p><?php echo $row['Title']?><br><?php echo $row['Description']?></p>
<?php
}
?>
</div>
...
<li>
<div class="info">
<p class="semi-bold">Company Name: <?php echo $row12['Company_name']?><br>Job Title: <?php echo $row11['Job']?><br>Start Date: <?php echo $row['Start_date']?><br>End Date: <?php echo $row['End_date']?><br>Details: <?php echo $row['Details']?></p>
</div>
</li>
</ul>
</div>

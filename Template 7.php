...
<tbody>
<tr>
<td style="width: 529px; vertical-align: top; background-color:#EDC9AF; text-align:left;"><big><big><big><big><span style="font-weight: bold;"><span style="color: rgb(0, 0, 153)"> Technical Resume</span> <span style="color:rgb(255, 153, 255);"></span></span></big></big></big></big><br>
...
<p class=a><img src="<?php echo "images/".$row['Profile_photo']; ?>" style="margin-left:30px" width="30%" height="20%" alt="Profile pic"></p>
<?php
}
?>
</div>
...
<button class="button" name="Download" onclick="printContent('print-resume')" ><b>DOWNLOAD</b> <i class="fas fa-download"></i></button>
<script>

<?php
	...
	if(isset($_POST["Add"]))
	{
		$Achievements=$_POST["A"];
		$sql = "Insert into achievement(User_id,Description) values('$user_id','$Achievements')";
...
<center><i class='fas fa-award'></i><b> Achievements & Awards</b></center>
<hr style="border-top:3px solid gray" ></hr>
<label><b>Achievements & Awards</b></label><br/>
<textarea cols="100" rows="10" name="A" placeholder="Your Achievements and Awards"></textarea>

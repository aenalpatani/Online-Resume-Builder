<?php
	...
	if(isset($_POST["Resume"]))
		header("location:TemplatesTechnical.html");
?>
<html>
<head>
...
<center><h2>Technical Person Profile</h2></center>
...
<button class="box"  name="Skills" style="font-size:24px"><i class="fas fa-star"></i>Skills</button>
<button class="box"  name="Objective" style="font-size:24px"><i class='far fa-life-ring'></i> Objective</button>
<b>More Sections</b>
<hr style="border-top:5px dashed gray" ></hr>
<button class="box"  name="Projects" style="font-size:24px"><i class='fas fa-plane'></i> Projects</button>
